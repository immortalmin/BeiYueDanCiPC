...
public class Toast
{
     ...
     */
    public void show(BaseToast toast, ToastClose close, long duration)
    {
     ...
     * @param text 展示的文本
     */
    public void showToast(Frame owner, int location, String text)
    {
     ...
     */
    public void showToast(Frame owner, int location, String text, long duration)
    {
     ...
     * @param duration Toast的持续时间
     */
    public void showToast(Frame owner, int location, ToastStatus status ,String text, long duration)
    {
